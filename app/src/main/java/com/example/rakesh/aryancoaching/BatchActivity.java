...
public class BatchActivity extends AppCompatActivity {
            ...
            db.child("Teacher").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                        ...
                        adapter = new CustomAdapter(BatchActivity.this, teachers);
    ...
    private void displayInputDialog() {
        ...
        quoteEditText = d.findViewById(R.id.subjectEditText);
            ...
            public void onClick(View v) {
                ...
                if (name != null && name.length() > 0) {
                    ...
                    if (helper.save(s)) {
                        ...
                        adapter = new CustomAdapter(BatchActivity.this, fetchedData);
                        mListView.setAdapter(adapter);
                        mListView.smoothScrollToPosition(fetchedData.size());
                    }
                } else {
                    Toast.makeText(BatchActivity.this, "Name Must Not Be Empty Please", Toast.LENGTH_SHORT).show();
                }
            }
        });
